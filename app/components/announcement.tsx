...
const Announcement = () => (
  <div className="flex w-full justify-center bg-linear-to-r from-purple-600 to-red-600 p-4 text-base font-medium text-white">
    <p className="">
      En octobre, venez vous initier au Yoga avec deux ateliers.{" "}
      <Button
        as={Link}
        variant="link"
        colorScheme="white"
